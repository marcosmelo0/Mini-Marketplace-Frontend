...
<div class="flex gap-8">
    ...
    <aside class="hidden lg:block w-64 flex-shrink-0">
        ...
        >
            <h2 class="text-lg font-semibold mb-4 text-white">Categorias</h2>
        ...
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-white mb-2">
                ...
                {:else if selectedCategory}
                    <span class="gradient-primary">{selectedCategory}</span>
                {:else}
                    Todos os <span class="gradient-primary">Serviços</span>
                {/if}
            </h1>
            <p class="text-gray-400">Encontre o serviço perfeito para você</p>
        </div>
